...
async function run() {
  try {
    ...
    console.log('Uploading fixed admin.js...');
    await ssh.putFile('./smartvault-api/src/routes/admin.js', '/tmp/admin.js');
    await ssh.execCommand(`echo "Snyasi@098765" | sudo -S cp /tmp/admin.js /opt/smartvault/smartvault-api/src/routes/admin.js`);

    console.log('Uploading fixed page.tsx...');
